...
- Examples (adjust to match the actual packages you are porting):
  - `@mariozechner/pi-coding-agent` → `@spell/pi-coding-agent`
  - `@mariozechner/pi-agent-core` → `@spell/pi-agent-core`
  - `@mariozechner/pi-tui` → `@spell/pi-tui`
  - `@mariozechner/pi-ai` → `@spell/pi-ai`
...
- In coding-agent, never use `console.log`/`console.warn`/`console.error`; use `logger` from `@spell/pi-utils`.
...
| Upstream                                           | Our Fork                                | Reason                                  |
| -------------------------------------------------- | --------------------------------------- | --------------------------------------- |
| `clipboard.ts` + `clipboard-image.ts` (tool files) | `@spell/pi-natives` clipboard module | Merged into N-API native implementation |
...
- `clipboard-image.ts` — clipboard is in `@spell/pi-natives` N-API module
