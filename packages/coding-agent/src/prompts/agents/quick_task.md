...
- You **SHOULD** prefer narrow search (find) then read only needed ranges. Do not bother yourself with anything beyond your current scope.
...
- `find` remains unrestricted for inspection.
</scope>