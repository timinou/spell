...
import { TERMINAL } from "@spell/pi-tui";
import {
	getDefault,
	getEnumValues,
	getPathsForTab,
...
const OPTION_PROVIDERS: Partial<Record<SettingPath, OptionProvider>> = {
	...
	"tools.artifactSpillThreshold": [
		...
		{ value: "2.5", label: "2.5 KB", description: "Default; ~625 tokens" },
		...
		{ value: "50", label: "50 KB", description: "Legacy lenient default; ~12.5K tokens" },
	...
	"tools.artifactTailBytes": [
		{ value: "1", label: "1 KB", description: "Default; ~250 tokens" },
		{ value: "2.5", label: "2.5 KB", description: "~625 tokens" },
		{ value: "5", label: "5 KB", description: "Failure inline tail; ~1.25K tokens" },
		{ value: "10", label: "10 KB", description: "~2.5K tokens" },
		{ value: "20", label: "20 KB", description: "Legacy wrapper tail; ~5K tokens" },
		{ value: "50", label: "50 KB", description: "~12.5K tokens" },
		{ value: "100", label: "100 KB", description: "~25K tokens" },
		{ value: "200", label: "200 KB", description: "~50K tokens" },
	],
	"tools.artifactTailLines": [
		{ value: "50", label: "50 lines", description: "Default; ~250 tokens" },
		{ value: "100", label: "100 lines", description: "~500 tokens" },
		{ value: "250", label: "250 lines", description: "~1.25K tokens" },
		{ value: "500", label: "500 lines", description: "Legacy wrapper tail; ~2.5K tokens" },
