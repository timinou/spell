...
import type { EditorTheme, MarkdownTheme, SelectListTheme, SymbolTheme } from "@spell/pi-tui";
import { adjustHsv, getCustomThemesDir, isEnoent, logger } from "@spell/pi-utils";
...
export function getSettingsListTheme(): import("@spell/pi-tui").SettingsListTheme {
	return {
