...
export type ModelRole = "default" | "smol" | "slow" | "vision" | "plan" | "review" | "commit" | "task";
...
export const MODEL_ROLE_IDS: ModelRole[] = ["default", "smol", "slow", "vision", "plan", "review", "commit", "task"];
