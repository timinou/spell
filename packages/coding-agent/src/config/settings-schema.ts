...
export const SETTINGS_SCHEMA = {
  ...
  "tools.artifactSpillThreshold": {
    ...
    ui: {
      ...
      description:
        "Default spill trigger for non-precision tools; outputs above this size spill to artifacts",
      submenu: true,
    },
  },
  "tools.artifactTailBytes": {
    ...
    ui: {
      ...
      description:
        "Default success tail kept inline for non-precision tools after artifact spill",
      submenu: true,
    },
  },
  "tools.artifactTailLines": {
    ...
    ui: {
      ...
      description:
        "Default success line tail kept inline for non-precision tools after artifact spill",
      submenu: true,
    },
  },
  ...
  "loop.autoApproveTimeoutMs": {
    ...
    ui: {
      ...
      description:
        "Milliseconds before human gates are auto-approved (0 = disabled)",
      submenu: true,
    },
  },
  ...
  "caveman.defaultLevel": {
    ...
    ui: {
      ...
      description:
        "Token-saving communication level applied on new sessions (off = disabled)",
    },
  },
  ...
  "caveman.showStatus": {
    ...
    ui: {
      ...
      description:
        "Show animated campfire status indicator when caveman mode is active",
    },
  },
  ...
  "caveman.thinkingMode": {
    ...
    ui: {
      ...
      description:
        "Thinking block style: compressed symbolic notation (default) or verbose prose",
    },
  },
  ...
  "ask.timeout": {
    ...
    ui: {
      ...
      label: "Ask Timeout",
      description:
        "Auto-select recommended option after timeout (0 to disable)",
      submenu: true,
    },
  },
  ...
  "compaction.strategy": {
    ...
    ui: {
      ...
      description:
        "Choose in-place context-full maintenance, auto-handoff, or disable auto maintenance (off)",
      submenu: true,
    },
  },
  ...
  "ttsr.enabled": {
    ...
    ui: {
      ...
      label: "TTSR",
      description:
        "Time Traveling Stream Rules: interrupt agent when output matches patterns",
    },
  },
  ...
  "edit.previewResolvePolicy": {
    ...
    ui: {
      ...
      description:
        "Require explicit resolve or auto-apply previewed structural edits",
    },
  },
  ...
  readHashLines: {
    ...
    ui: {
      ...
      label: "Hash Lines",
      description:
        "Include line hashes in read output for hashline edit mode (LINE#ID:content)",
    },
  },
  ...
  "todo.eager": {
    ...
    ui: {
      ...
      description:
        "Automatically create a comprehensive todo list after the first message",
    },
  },
  ...
  "renderMermaid.enabled": {
    ...
    ui: {
      ...
      description:
        "Enable the render_mermaid tool for Mermaid-to-ASCII rendering",
    },
  },
  ...
  "mcp.discoveryMode": {
    ...
    ui: {
      ...
      description:
        "Hide MCP tools by default and expose them through a tool discovery tool",
    },
  },
  ...
  "mcp.notificationDebounceMs": {
    ...
    ui: {
      ...
      description:
        "Debounce window for MCP resource update notifications before injecting into conversation",
    },
  },
  ...
  "task.eager": {
    ...
    ui: {
      ...
      description:
        "Encourage the agent to delegate work to subagents unless changes are trivial",
    },
  },
  ...
  "task.autoRoster": {
    ...
    ui: {
      ...
      label: "Auto-Roster",
      description:
        "Automatically create todo roster entries when dispatching tasks",
    },
  },
  ...
  "task.maxRecursionDepth": {
    ...
    ui: {
      ...
      description:
        "Max nesting depth for subagent spawns (2 = main -> subagent -> sub-subagent)",
      submenu: true,
    },
  },
  ...
  "task.maxToolCalls": {
    ...
    ui: {
      ...
      description:
        "Maximum tool calls per subagent before forced termination. Set 0 to disable.",
      submenu: true,
    },
  },
  ...
  "task.cacheStaggerMs": {
    ...
    ui: {
      ...
      description:
        "Delay between launching sibling subagents for prompt cache hits. Set 0 to disable.",
      submenu: true,
    },
  },
  ...
  "providers.parallelFetch": {
    ...
    ui: {
      ...
      description:
        "Use Parallel extract API for URL fetching when credentials are available",
    },
  },
  ...
  "org.enabled": {
    ...
    ui: {
      tab: "tools",
      label: "Enable Org",
      description: "Enable the org tool for project management",
    },
  },
  "org.todoKeywords": {
    type: "array",
