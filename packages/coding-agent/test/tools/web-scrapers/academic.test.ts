...
import { handleArxiv } from "@spell/pi-coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@spell/pi-coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@spell/pi-coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@spell/pi-coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@spell/pi-coding-agent/web/scrapers/types";
