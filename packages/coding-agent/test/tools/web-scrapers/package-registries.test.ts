...
import { handleCratesIo } from "@spell/pi-coding-agent/web/scrapers/crates-io";
import { handleGoPkg } from "@spell/pi-coding-agent/web/scrapers/go-pkg";
import { handleHex } from "@spell/pi-coding-agent/web/scrapers/hex";
import { handleNpm } from "@spell/pi-coding-agent/web/scrapers/npm";
import { handlePubDev } from "@spell/pi-coding-agent/web/scrapers/pub-dev";
import { handlePyPI } from "@spell/pi-coding-agent/web/scrapers/pypi";
