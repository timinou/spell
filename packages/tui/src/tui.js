...
export class TUI extends Container {
    ...
    #cellSizeQueryPending;
    #sixelProbePendingDa;
    #sixelProbePendingGraphics;
    #sixelProbeBuffer;
    #sixelProbeTimeout;
    #sixelProbeUnsubscribe;
    #showHardwareCursor;
    #clearOnShrink; // Clear empty rows when content shrinks (default: off)
    ...
    #getSixelProbePartialStart(buffer) {
    ...
    #finishSixelProbe(supported) {
        this.#clearSixelProbeState();
        if (!supported || TERMINAL.imageProtocol)
            return;
