		...
		const manifest = createMinimalManifest({
			setups: new Map([
				[
					...
					{
						domain: "coding",
						stateStores: new Map([["workflow", { backend: "sqlite", path: "./data/workflow.db" }]]),
					},
				],
			]),
			goals: new Map([
			...
			setups: new Map([
				[
					"worker",
					{
						domain: "coding",
						stateStores: new Map([
							["workflow", { backend: "sqlite", path: "./data/workflow.db", schema: "workflow-db" }],
						]),
					},
				],
			]),
		...
		const manifest = createMinimalManifest({
			setups: new Map([
				[
					...
					{
						domain: "coding",
						stateStores: new Map([["workflow", { backend: "sqlite", path: "./data/setup.db" }]]),
					},
				],
			]),
			goals: new Map([
