...
```bash
npm install @spell/pi-ai
```

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from "@spell/pi-ai";
...
```typescript
import { Type, Tool, StringEnum } from "@spell/pi-ai";
...
```typescript
import { stream, validateToolCall, Tool } from "@spell/pi-ai";
...
```typescript
import * as fs from "node:fs";
import { getModel, complete } from "@spell/pi-ai";
...
```typescript
import { getModel, streamSimple, completeSimple } from "@spell/pi-ai";
...
```typescript
import { getModel, stream } from "@spell/pi-ai";
...
```typescript
import { getProviders, getModels, getModel } from "@spell/pi-ai";
...
```typescript
import { Model, stream } from "@spell/pi-ai";
...
```typescript
import { getModel, complete, Context } from "@spell/pi-ai";
...
```typescript
import { Context, getModel, complete } from "@spell/pi-ai";
...
bunx @spell/pi-ai login vllm         # store vLLM API key (or placeholder for local no-auth)
bunx @spell/pi-ai list               # list available providers
```
...
```typescript
import { loginGitHubCopilot } from "@spell/pi-ai";
import * as fs from "node:fs";
...
```typescript
import { getModel, complete, getOAuthApiKey } from "@spell/pi-ai";
import * as fs from "node:fs";
