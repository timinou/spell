...
export const PROVIDER_DESCRIPTORS: readonly ProviderDescriptor[] = [
	...
	catalogDescriptor(
		"inception",
		"mercury-2",
		config => inceptionModelManagerOptions(config),
		catalog("Inception", ["INCEPTION_API_KEY"]),
	),
	catalogDescriptor(
		"huggingface",
	...
	catalogDescriptor(
		...
		catalog("DeepSeek", ["DEEPSEEK_API_KEY"], { oauthProvider: "deepseek" }),
	),
